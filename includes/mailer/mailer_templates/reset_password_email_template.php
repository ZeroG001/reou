...
<html>
  ...
  */
  ...
  <table style="width: 600px; font-size: 1em; margin: 0px auto; background-color: white">
   
    <tr>
        <td style="text-align: center; padding: 40px 0px">  
          <img src="https://dl.dropboxusercontent.com/u/58601120/loop2.svg" alt="resetImage">
        </td>
    </tr>
   
   
    <table style="width: 600px; font-family: sans-serif; padding: 0px 0px; font-size: 1em; margin: 0px auto; background-color: white; padding: 0px 0px 50px 0px; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px">
    
      <tr>
        <td style="text-align: center;">  
          <h2 style="margin: 0 0 0.8em;font-weight: inherit;line-height: 1.2;font-size: 2.369em;"> Password Reset Request </h2>
        </td>
      </tr>
      <tr>
        <td style="text-align: center;"> 
